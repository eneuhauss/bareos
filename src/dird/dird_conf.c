...
static RES_ITEM dir_items[] = {
   ...
   { "fdconnecttimeout", store_time, ITEM(res_dir.FDConnectTimeout), 0, ITEM_DEFAULT, "180" /* 3 * 60 */ },
   { "sdconnecttimeout", store_time, ITEM(res_dir.SDConnectTimeout), 0, ITEM_DEFAULT, "1800" /* 30 * 60 */ },
   ...
   { "statisticsretention", store_time, ITEM(res_dir.stats_retention), 0, ITEM_DEFAULT, "160704000" /* 60 * 60 * 24 * 31 * 12 * 5 */ },
...
static RES_ITEM cli_items[] = {
   ...
   { "fileretention", store_time, ITEM(res_client.FileRetention), 0, ITEM_DEFAULT, "5184000" /* 60 * 60 * 24 * 60 */ },
   { "jobretention", store_time, ITEM(res_client.JobRetention), 0, ITEM_DEFAULT, "15552000" /* 60 * 60 * 24 * 180 */ },
...
static RES_ITEM pool_items[] = {
   ...
   { "volumeretention", store_time, ITEM(res_pool.VolRetention), 0, ITEM_DEFAULT, "31536000" /* 60 * 60 * 24 * 365 */ },
